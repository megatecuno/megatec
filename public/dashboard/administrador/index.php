...
<div class="main-content">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <a href="<?= URL_BASE ?>dashboard/administrador/usuarios.php"
            style="background:#4db6ac; color:white; padding:1rem; border-radius:8px; text-align:center; text-decoration:none;">
            ?? Gestionar Usuarios
        </a>
        <a href="<?= URL_BASE ?>dashboard/administrador/operarios.php"
            style="background:#4db6ac; color:white; padding:1rem; border-radius:8px; text-align:center; text-decoration:none;">
            ?? Gestionar Operarios
        </a>
        <a href="<?= URL_BASE ?>dashboard/administrador/ml_articulos.php"
            style="background:#4db6ac; color:white; padding:1rem; border-radius:8px; text-align:center; text-decoration:none;">
            ?? ML Artículos
        </a>
        <a href="<?= URL_BASE ?>dashboard/administrador/perfil.php"
            style="background:#4db6ac; color:white; padding:1rem; border-radius:8px; text-align:center; text-decoration:none;">
            ?? Mi Perfil
        </a>
    </div>
